package cn.edu.gamec.android.boxuegu.utils;
...
import cn.edu.gamec.android.boxuegu.bean.UserBean;
import cn.edu.gamec.android.boxuegu.bean.VideoBean;
import cn.edu.gamec.android.boxuegu.sqlite.SQLiteHelper;
...
public class DBUtils {
    ...
    public void saveVideoPlayList(VideoBean bean, String userName){
        ...
        db.insert(SQLiteHelper.U_VIDEO_PLAY_LISY,null,cv);
    }
    //判断视频记录是否存在
    public boolean hasVideoPlay (int chapterId, int videoId, String userName){
        boolean hasVideo = false;
        String sql = "SELECT * FROM " + SQLiteHelper.U_VIDEO_PLAY_LISY + " WHERE chapterId=? AND videoId=? AND userName=?";
    ...
    public boolean delVideoPlay(int chapterId, int videoId, String userName){
        ...
        int row = db.delete(SQLiteHelper.U_VIDEO_PLAY_LISY,
    ...
    public List<VideoBean> getVideoHistory(String userName){
        String sql = "SELECT * FROM "+ SQLiteHelper.U_VIDEO_PLAY_LISY+" WHERE userName=?";
        Cursor cursor = db.rawQuery(sql,new String[]{userName});
